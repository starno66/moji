...
/* ====== 菜单栏 ====== */
QMenuBar { background: #1e293b; color: #e2e8f0; padding: 2px 6px; font-size: 15px; }
...
QLabel#chapterTitleLabel, QLabel#historyTitleLabel, QLabel#commitDetailTitle {
  font-size: 16px; font-weight: bold; color: #1e293b; padding: 2px 0; }
QLabel#filterLabel { font-size: 15px; font-weight: bold; color: #1e293b; }

/* ====== 列表视图 ====== */
QListView { background: transparent; border: none; padding: 2px; outline: none; font-size: 15px; }
...
QComboBox { background: #f8fafc; border: 1px solid #e2e8f0; border-radius: 8px;
            padding: 5px 10px; min-width: 60px; font-size: 14px; }
...
QStatusBar { background: #ffffff; border-top: 1px solid #e2e8f0;
            color: #64748b; font-size: 14px; padding: 3px 10px; }
...
QGroupBox { font-weight: bold; border: none; border-radius: 10px;
           margin-top: 10px; padding: 16px 12px 12px 12px; font-size: 15px; }
QGroupBox::title { subcontrol-origin: margin; left: 12px; padding: 0 4px; }

/* ====== 弹窗 ====== */
QDialog { min-width: 480px; }
QDialog QLabel { font-size: 15px; }
QDialog QLineEdit { font-size: 15px; padding: 8px 12px; }
QDialog QPushButton { font-size: 15px; padding: 8px 22px; }
)";
