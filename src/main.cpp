...
QMenuBar { background: #24292f; color: #ffffff; padding: 1px 6px;
           font-size: 13px; }
...
QLabel#chapterTitleLabel, QLabel#historyTitleLabel, QLabel#commitDetailTitle {
  font-size: 14px; font-weight: 600; color: #1f2328; padding: 1px 0; }
QLabel#filterLabel { font-size: 13px; color: #656d76; }

QListView { background: #ffffff; border: none; border-radius: 6px;
            padding: 4px; outline: none; font-size: 14px; }
...
QComboBox { background: #f6f8fa; border: none; border-radius: 6px;
            padding: 3px 10px; min-width: 60px; font-size: 13px; }
...
QStatusBar { background: #ffffff; border-top: 1px solid #eaeef2;
            color: #656d76; font-size: 12px; padding: 2px 8px; }
...
QGroupBox { font-weight: 600; border: none; border-radius: 6px;
           margin-top: 10px; padding: 14px 10px 10px 10px; font-size: 13px; }
